...
#logDat = logging.LogFile('sustained_start_check.log', filemode='w', level = logging.INFO)
...
logDat = logging.LogFile(paths['subject']+'_run'+info['run']+'.log', filemode='w', level = logging.DEBUG)
...
logging.info('FRAME RATE: ' + str(rate))
logging.flush()
